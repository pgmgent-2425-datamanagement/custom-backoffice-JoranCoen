...
<nav class="bg-base-300 w-56 p-4 shadow-lg">
    <div class="mb-6">
        <a class="text-2xl font-bold text-white">BitVault</a>
    </div>
    <ul class="menu menu-vertical flex flex-col space-y-2">
        <li>
            <details open>
                <summary>
...
<main class="flex-grow p-6 bg-base-100 shadow-inner">
    <?= $content; ?>
</main>
